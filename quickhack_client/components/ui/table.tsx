// QuickHack note: ERP/WMS 데이터 표에 쓰는 공통 Table 스타일 컴포넌트 묶음입니다.
...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto bg-popover">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("h-11 px-3 align-middle", className)}
    {...props}
  />
));
